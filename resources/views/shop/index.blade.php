            ...
            <div class="flex flex-col lg:flex-row gap-8">
                <aside class="w-full lg:w-1/4 order-2 lg:order-1 space-y-8">
                    ...
                    <div class="bg-gray-50 p-6 rounded-lg border">
                        <form class="relative">
                            <input type="text" name="search" value="{{ old('search', request('search')) }}" placeholder="Search product..." class="w-full border p-3 rounded focus:outline-none focus:border-primary pr-10">
                            <button type="submit" class="absolute right-3 top-3 text-gray-400 hover:text-primary"><i class="fa fa-search"></i></button>
                        </form>
                    </div>
                    ...
                    <div class="bg-gray-50 p-6 rounded-lg border">
                        ...
                        <div class="relative pt-6 pb-2">
                            ...
                            <!-- The Backbround Track -->
                            <div class="absolute w-full h-1 bg-gray-300 rounded top-6 z-0"></div>
                            
                            <!-- The Active Colored Track -->
                            <div id="range-track" class="absolute h-1 bg-primary rounded top-6 z-0" style="left: 0%; right: 0%;"></div>

                            <input type="range" name="min_price" min="0" max="1000000" value="{{ request('min_price', 0) }}" class="absolute w-full h-1 bg-transparent appearance-none top-6 left-0 pointer-events-none z-20 custom-range-slider price-slider" id="range-min">
                            <input type="range" name="max_price" min="0" max="1000000" value="{{ request('max_price', 1000000) }}" class="absolute w-full h-1 bg-transparent appearance-none top-6 left-0 pointer-events-none z-20 custom-range-slider price-slider" id="range-max">
                            ...
                            <div class="flex justify-between mt-4 text-sm font-medium text-gray-600">
                                ...
                                <span>$<span id="price-max-display">{{ request('max_price', 1000000) }}</span></span>
                            </div>
                        </div>
                    </div>
