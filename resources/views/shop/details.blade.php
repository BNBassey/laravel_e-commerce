            ...
            <div class="flex flex-col lg:flex-row gap-12">
                ...
                <div class="w-full lg:w-1/2 overflow-hidden">
                    <div class="swiper-container gallery-top mb-4 rounded border bg-gray-50">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide"><img src="{{ asset('uploads/products')}}/{{ $product->image }}" alt="{{ $product->name }}"></div>
                            @if ($product->images)
                    ...
                    <div class="swiper-container gallery-thumbs">
                        <div class="swiper-wrapper">
                            ...
                            @if ($product->images)
                                @foreach (explode(',', $product->images) as $image)
                                    <div class="swiper-slide cursor-pointer border rounded overflow-hidden opacity-50 hover:opacity-100 transition">
                                        <img src="{{ asset('uploads/products/thumbnails')}}/{{ $image }}" class="w-full" alt="Thumb">
                                    </div>
                                @endforeach
                            @endif
                        </div>
                ...
                <div class="w-full lg:w-1/2">
                    ...
                    <div class="space-y-2 text-sm text-gray-600 border-t pt-6">
                        ...
                        <p><span class="font-bold text-gray-800 w-24 inline-block">Categories:</span> <a href="#" class="hover:text-primary">{{ $product->category->name }}</a>, <a href="#" class="hover:text-primary">Home</a></p>
                            ...
                            <div class="group text-center">
                                <div class="relative overflow-hidden bg-gray-100 rounded mb-4">
                                    <a href="{{ route('shop.product.details', $rproduct->slug) }}">
                                        <img src="{{ asset('uploads/products/thumbnails')}}/{{ $rproduct->image }}" class="w-full object-cover group-hover:scale-105 transition duration-500" alt="{{ $rproduct->name }}">
                                    </a>
