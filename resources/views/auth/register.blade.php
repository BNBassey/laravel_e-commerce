                ...
                <div class="w-full lg:w-1/2">
                    <div class="bg-gray-50 border rounded-lg p-8 shadow-sm">
                        ...
                        <form method="POST" action="{{ route('register') }}" class="space-y-4">
                            ...
                            <div >
                                <div>
                                    <input id="name" name="name" type="text" placeholder="Name" class="w-full border p-3 rounded focus:outline-none focus:border-primary transition" :value="old('name')" required autofocus autocomplete="name"/>
                                    @error('name')
                            ...
                            <div>
                                <input id="email" name="email" type="email" placeholder="Email Address *" class="w-full border p-3 rounded focus:outline-none focus:border-primary transition" :value="old('email')" required autofocus autocomplete="email" />
                                @error('email')
                                    <p class="text-red-500 text-sm mt-1"> {{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                <input id="mobile" name="mobile" type="text" placeholder="Mobile *" class="w-full border p-3 rounded focus:outline-none focus:border-primary transition" :value="old('mobile')" required autofocus autocomplete="mobile"/>
                                @error('mobile')
                                    <p class="text-red-500 text-sm mt-1"> {{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                <input id="password" name="password" type="password" placeholder="Password" class="w-full border p-3 rounded focus:outline-none focus:border-primary transition" required autocomplete="new-password" />
                                @error('password')
                                    <p class="text-red-500 text-sm mt-1"> {{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                <input id="password_confirmation" name="password_confirmation" type="password" placeholder="Confirm Password" class="w-full border p-3 rounded focus:outline-none focus:border-primary transition" required autocomplete="new-password" />
                            </div>
