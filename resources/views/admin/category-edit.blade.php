        ...
        <div class="max-w-3xl mx-auto">
            <form method="POST" action="{{ route('admin.category.update',['id'=>$category->id]) }}" enctype="multipart/form-data" class="bg-white rounded-xl shadow-sm border border-gray-100 p-8 space-y-6">
                ...
                <div>
                    ...
                    <select name="parent_id" id="parent_id" class="w-full border px-4 py-2 rounded-lg outline-none focus:ring-1 focus:ring-primary bg-white">
                ...
                <div class="flex flex-col md:flex-row gap-8 items-start pt-4">
                    ...
                    <div class="w-full md:w-1/3">
                        ...
                        <div class="h-40 w-full border rounded-lg bg-white flex items-center justify-center p-4">
                            <img src="{{ asset('uploads/categories/thumbnails') }}/{{ $category->image }}" class="max-h-full max-w-full object-contain" alt="{{ $category->name }}" onerror="this.src='https://placehold.co/40x40?text=B'">
                        </div>
                    </div>
                    @endif
